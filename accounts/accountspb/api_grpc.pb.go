...
const (
	AccountsService_RefreshToken_FullMethodName = "/accountspb.AccountsService/RefreshToken"
)
...
var AccountsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "accountspb.AccountsService",
